      ...
      <TopBar
        ...
        right={
          <Link
            ...
            className="w-9 h-9 bg-gold rounded-xl flex items-center justify-center active:opacity-80"
          >
        ...
        {staff.length === 0 ? (
          ...
          staff.map((s) => (
            ...
            >
              ...
              {s.active ? (
                <span className="text-[10px] font-semibold text-success bg-success-light rounded-full px-2 py-1">
                  Active
                </span>
              ) : (
                <span className="text-[10px] font-semibold text-danger bg-danger-100 rounded-full px-2 py-1">
                  Deactivated
                </span>
              )}
            </Link>
