...
// Shared grid + lightbox behind ReferenceImageGallery and MaterialImageGallery
// — both are the same "array of image URLs, tap to zoom" pattern, differing
// only in labels.
export default function ImageGallery({ images, altPrefix, emptyIcon, emptyText }: Props) {
